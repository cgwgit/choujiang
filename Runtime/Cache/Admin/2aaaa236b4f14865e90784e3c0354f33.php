			...
			<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<?php if(is_array($action)): foreach($action as $key=>$v): ?><tr class="text-c">
							...
							<td class="td-status" id="kai"><?php if($v['status'] == 1): ?><span class="label label-success radius">已开启</span><?php else: ?><span class="label label-default radius">已关闭</span><?php endif; ?></td>
